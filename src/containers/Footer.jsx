  ...
  return (
    <footer className="max-container">
      <div className="flex justify-between items-start gap-20 flex-wrap">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm">
            ...
            fugit tenetur enim labore, maiores iusto.
          </p>
          <div className="flex items-center gap-5 mt-8">
            {socialMedia.map((icon) => (
              <motion.div className="flex justify-center items-center w-12 h-12 bg-white rounded-full"whileHover={{boxShadow :"0px 0px 15px rgb(255,101,33)",scale:1.1}}>
      ...
      <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
        ...
        <p className="ont-montserrat cursor-pointer">Terms & Conditions</p>
      </div>
    </footer>
  );
};
